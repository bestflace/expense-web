...
export function OnboardingScreen({ onComplete, language }: OnboardingScreenProps) {
  ...
  const slides = language === 'vi' ? [
    {
      title: 'Chào mừng đến ExpenseTracker',
      description: 'Giải pháp quản lý tài chính cá nhân toàn diện, giúp bạn kiểm soát chi tiêu và đạt mục tiêu tài chính.',
      icon: '💰',
      gradient: 'from-blue-500 to-indigo-600'
    },
    {
      title: 'Theo dõi chi tiêu thông minh',
      description: 'Ghi chú mọi khoản thu chi, phân loại theo danh mục và ví riêng biệt. Dễ dàng quản lý từng đồng tiền.',
      icon: '📊',
      gradient: 'from-purple-500 to-pink-600'
    },
    {
      title: 'Thống kê trực quan',
      description: 'Biểu đồ chi tiết, báo cáo tháng/năm và xuất Excel. Hiểu rõ thói quen chi tiêu của bạn.',
      icon: '📈',
      gradient: 'from-green-500 to-emerald-600'
    },
    {
      title: 'Cảnh báo ngân sách',
      description: 'Đặt hạn mức chi tiêu hàng tháng và nhận thông báo khi vượt ngưỡng. Kiểm soát tài chính hiệu quả.',
      icon: '🔔',
  ...
  ] : [
    {
      ...
      description: 'Comprehensive personal finance solution to help you control spending and achieve financial goals.',
      icon: '💰',
      gradient: 'from-blue-500 to-indigo-600'
    },
    {
      title: 'Smart Expense Tracking',
      description: 'Record all transactions, categorize by type and wallet. Easily manage every penny.',
      icon: '📊',
      gradient: 'from-purple-500 to-pink-600'
    },
    {
      title: 'Visual Statistics',
      description: 'Detailed charts, monthly/yearly reports and Excel export. Understand your spending habits.',
      icon: '📈',
      gradient: 'from-green-500 to-emerald-600'
    },
    {
      title: 'Budget Alerts',
      description: 'Set monthly spending limits and receive notifications when exceeding threshold. Control finances effectively.',
      icon: '🔔',
      gradient: 'from-orange-500 to-red-600'
    }
  ];
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 flex items-center justify-center p-6">
      <div className="max-w-4xl w-full">
        ...
        >
          <p className="text-sm">ExpenseTracker v1.0.0</p>
